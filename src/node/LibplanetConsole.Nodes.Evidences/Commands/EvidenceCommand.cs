...
namespace LibplanetConsole.Nodes.Evidences.Commands;
    ...
    : CommandMethodBase
{
    ...
    public async Task ListAsync(CancellationToken cancellationToken = default)
    {
        ...
        var evidenceInfos = isPending == true ?
            await evidenceNode.GetPendingEvidencesAsync(cancellationToken) :
            await evidenceNode.GetEvidencesAsync(height, cancellationToken);
