...
using TService = LibplanetConsole.Grpc.Guild.GuildGrpcService.GuildGrpcServiceClient;

namespace LibplanetConsole.Console.Guild;

internal sealed class ClientGuild(
    [FromKeyedServices(IClient.Key)] IClient client)
    : GrpcClientContentBase<TService>(client, "client-guild"), IClientGuild
{
