    ...
    : CommandMethodBase(nodeCommand, "guild")
{
    ...
    public async Task NewAsync(CancellationToken cancellationToken = default)
    {
        ...
        await guild.CreateAsync(options.Sign(node), cancellationToken);
    ...
    public async Task DeleteAsync(CancellationToken cancellationToken = default)
    {
        ...
        var guildAddress = await guild.DeleteAsync(options.Sign(node), cancellationToken);
        ...
        Address guildAddress, CancellationToken cancellationToken = default)
    {
        ...
        await guild.RequestJoinAsync(options.Sign(node), cancellationToken);
        await Out.WriteLineAsync(message);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await guild.CancelJoinAsync(options.Sign(node), cancellationToken);
        await Out.WriteLineAsync(message);
    }
        ...
        Address memberAddress, CancellationToken cancellationToken = default)
    {
        ...
        await guild.AcceptJoinAsync(options.Sign(node), cancellationToken);
        await Out.WriteLineAsync(message);
    }
        ...
        Address memberAddress, CancellationToken cancellationToken = default)
    {
        ...
        await guild.RejectJoinAsync(options.Sign(node), cancellationToken);
        await Out.WriteLineAsync(message);
    }
    ...
    public async Task LeaveAsync(CancellationToken cancellationToken)
    {
        ...
        await guild.QuitAsync(options.Sign(node), cancellationToken);
        await Out.WriteLineAsync(message);
    }
        ...
        Address memberAddress, CancellationToken cancellationToken)
    {
        ...
        await guild.BanMemberAsync(options.Sign(node), cancellationToken);
        await Out.WriteLineAsync(message);
    }
        ...
        Address memberAddress, CancellationToken cancellationToken)
    {
        ...
        await guild.UnbanMemberAsync(options.Sign(node), cancellationToken);
        await Out.WriteLineAsync(message);
    }
