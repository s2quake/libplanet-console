...
internal abstract class AddressCollectionBase : IAddressCollection
{
    ...
    public void Add(string alias, Address address) => Add(alias, address, string.Empty);

    public void Add(string alias, Address address, string category)
    {
        _addressInfoByAlias.Add(alias, new AddressInfo
        {
            Alias = alias,
            Address = address,
            Category = category,
    ...
    public AddressInfo[] GetAddressInfos(params string[] categories)
    {
        ...
        var query = from addressInfo in _addressInfoByAlias.Values.OfType<AddressInfo>()
                    where categories.Contains(addressInfo.Category)
                    select addressInfo;
        return [.. query];
    }
