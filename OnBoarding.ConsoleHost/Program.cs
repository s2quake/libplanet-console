...
namespace OnBoarding
{
    internal class Program
    {
        ...
        private static BlockChain CreateBlockChain(PrivateKey privateKey)
        {
            ...
            // var preEvaluationBlockHeader = new PreEvaluationBlockHeader(blockMetadata, hashDigest);

            // BlockChain.DetermineGenesisStateRootHash()

            // var blockHeader = new BlockHeader(preEvaluationBlockHeader, (StateRootHash: hashDigest, null, blockHash));
            // var invoice = new TxInvoice();
            // var unsignedTx = new UnsignedTx(invoice, new TxSigningMetadata(publicKey, nonce));
            // var transaction = new Transaction(unsignedTx, privateKey);
